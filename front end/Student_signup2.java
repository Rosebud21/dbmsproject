	...
	public void actionPerformed(ActionEvent event) {
		...
		if (event.getSource() == jButton1) {
			...
			if ((jTextField1.getText().equals("")) || (jTextField2.getText().equals("")) ||
				(Combo1.getSelectedItem() == ("")) || (Combo2.getSelectedItem() == ("")) ||
				(jPasswordField1.getText().equals("")) || (jPasswordField2.getText().equals(""))|| (!pwd.equals(pwd2))) {
					JOptionPane.showMessageDialog(null, "INVALID DETAILS.PLEASE TRY AGAIN");

			} else {
				try {
					// new Student(roll, name, pwd, year, branch);
					String args= "?rollnum="+roll+"&name="+name+"&password="+pwd+"&year="+year+"&branch="+branch;
					URL urlForGetRequest = new URL("http://localhost:5499/student/signup/"+args);
